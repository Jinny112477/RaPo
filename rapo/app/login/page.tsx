...
const demoAccounts = [
  { email: 'sarah.chen@company.com', role: 'Admin', color: 'bg-blue-100 text-blue-700 border-blue-200' },
  { email: 'm.torres@company.com', role: 'Data Owner', color: 'bg-emerald-100 text-emerald-700 border-emerald-200' },
  { email: 'e.vasquez@company.com', role: 'DPO', color: 'bg-purple-100 text-purple-700 border-purple-200' },
  { email: 'r.nguyen@company.com', role: 'Auditor', color: 'bg-slate-100 text-slate-700 border-slate-200' },
  { email: 'c.blake@company.com', role: 'Executive', color: 'bg-amber-100 text-amber-700 border-amber-200' },
];
